Programa en C que permite exportar offset de FSUIPC a MQTT e importar offset desde MQTT a FSUIPC para controlar el simulador
...
escucha_mqtt puede ser 1 o 0 y esto habilita a escribir datos en FSUIPC
